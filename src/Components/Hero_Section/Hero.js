...
<main class="pt-16">
        ...
        <section class="relative bg-gradient-to-br from-[#070a37] to-indigo-800 text-white overflow-hidden border-none ">
            ...
            <div class="container mx-auto px-4 py-24 md:py-32 relative z-10">
                <div class="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="w-full md:w-1/2 mb-12 md:mb-0">
                        <h1 class="text-5xl md:text-6xl font-bold mb-6 leading-tight pl-4">   Innovate.<br/>Transform.<br/>Succeed. </h1>
                        <p class="text-xl mb-8 text-gray-300 pl-4">Empowering businesses with cutting-edge solutions for button digital future.</p>
