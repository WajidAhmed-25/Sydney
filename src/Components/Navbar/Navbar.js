...
export default function MyNavbar() {
	...
	return (
		<>
			<div onMouseLeave={handleMouseLeave}>
				{/* Desktop View */}
				{/* <nav className="fixed bg-gradient-to-b from-[#ffffff]  via-[#ffffff] to-[#ffffff] border-b-4 border-[#7e387d]  z-[1000] w-full px-4 py-[6px] flex justify-between items-center"> */}
  ...
  >
    ...
    before:content-[''] before:absolute before:left-0 before:-bottom-1 before:w-0 before:h-[2px] before:bg-current before:transition-all before:duration-300 hover:before:w-full" onClick={toggleDropdown}>
							...
							{isDropdownOpen && (
								<ul className="absolute mt-6 -ml-16 text-center transition duration-200 ease-in-out transform bg-white  border-[#0b10567e] border-2 rounded-lg shadow-xl w-72 -left-6 hover:scale-105 hover:shadow-2xl" onMouseLeave={handleMouseLeave}>
...
<li className="relative" onMouseEnter={handleMouseEnter}>
  ...
  <li><button className="block w-full px-4 py-2 text-sm font-medium text-gray-700 transition duration-200 ease-in-out transform rounded-md hover:text-[#0b1056] hover:bg-gray-100 hover:scale-105">Group/Centre Activities</button></li>
    ...
    before:content-[''] before:absolute before:left-0 before:-bottom-1 before:w-0 before:h-[2px] before:bg-current before:transition-all before:duration-300 hover:before:w-full">Contact</button></li>
				...
				{/* <div className="navbar-menu relative z-[1000] hidden">
					...
					<nav className="fixed top-0 bottom-0 left-0 flex flex-col w-3/4 max-w-sm px-6 py-6 overflow-y-auto bg-white border-r">
						<div className="flex items-center mb-8">
							<button className="mr-auto text-3xl font-bold leading-none" >
						...
						<div>
							<ul className='flex flex-col items-center justify-center w-full space-y-4 '>
								<li className="mb-1"><button onClick={() => handleNavigation('/')} className="block p-4 text-sm font-semibold text-gray-400 rounded hover:bg-blue-50 hover:text-blue-600">Home</button></li>
								<li className="mb-1"><button onClick={() => handleNavigation('/AboutUs')} className="block p-4 text-sm font-semibold text-gray-400 rounded hover:bg-blue-50 hover:text-blue-600">About Us</button></li>
								<li className="relative">
									<button className="block p-4 text-sm font-semibold text-gray-400 rounded hover:bg-blue-50 hover:text-blue-600" onClick={toggleDropdown}>
										Services
									</button>
									{isDropdownOpen && (
							
										<ul className="absolute w-64 mt-2 bg-white border rounded shadow-lg -right-20">
  <li><button className="block w-full px-4 py-2 text-sm font-medium text-gray-700 transition duration-200 ease-in-out transform rounded-md hover:text-[#0b1056] hover:bg-gray-100 hover:scale-105">Assist Access/Maintain Employ</button></li>
  <li><button className="block w-full px-4 py-2 text-sm font-medium text-gray-700 transition duration-200 ease-in-out transform rounded-md hover:text-[#0b1056] hover:bg-gray-100 hover:scale-105">Assist Prod-Pers Care/Safety</button></li>
  <li><button className="block w-full px-4 py-2 text-sm font-medium text-gray-700 transition duration-200 ease-in-out transform rounded-md hover:text-[#0b1056] hover:bg-gray-100 hover:scale-105">Assist-Life Stage, Transition</button></li>
  <li><button className="block w-full px-4 py-2 text-sm font-medium text-gray-700 transition duration-200 ease-in-out transform rounded-md hover:text-[#0b1056] hover:bg-gray-100 hover:scale-105">Assist-Personal Activities</button></li>
  ...
  <li><button className="block w-full px-4 py-2 text-sm font-medium text-gray-700 transition duration-200 ease-in-out transform rounded-md hover:text-[#0b1056] hover:bg-gray-100 hover:scale-105">Group/Centre Activities</button></li>
								...
								<li className="mb-1"><button onClick={() => handleNavigation('/NDIS')} className="block p-4 text-sm font-semibold text-gray-400 rounded hover:bg-blue-50 hover:text-blue-600">NDIS</button></li>
								<li className="mb-1"><button onClick={() => handleNavigation('/Careers')} className="block p-4 text-sm font-semibold text-gray-400 rounded hover:bg-blue-50 hover:text-blue-600">Careers</button></li>
								<li className="mb-1"><button onClick={() => handleNavigation('/ContactUs')} className="block p-4 text-sm font-semibold text-gray-400 rounded hover:bg-blue-50 hover:text-blue-600">Contact</button></li>
							</ul>
						</div>
        ...
        <li className="relative">
          ...
          {isDropdownOpen && (
            <ul className="absolute w-64 mt-2 -left-20 bg-white border rounded shadow-lg z-[1100] right-0 transform translate-y-2">
              <li>
                <button className="block w-full px-4 py-2 text-sm font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-[#0b1056] transition duration-200 ease-in-out transform hover:scale-105">
