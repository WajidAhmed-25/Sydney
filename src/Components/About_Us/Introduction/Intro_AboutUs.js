                ...
                <div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8 ">
                        <div class="max-w-lg ">
                            ...
                            <p class="mt-8 text-gray-600 text-lg "><br/><br/>Sydney 24/7 Care is a registered NDIS provider in Sydney, providing an extensive array of NDIS services and therapies to our participants, including mobile therapeutic services.<br/><br/>
