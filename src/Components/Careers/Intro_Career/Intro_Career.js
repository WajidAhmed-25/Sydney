      ...
      <section className="mb-8">
        <div className="container max-w-xl p-6 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
          <div>
            ...
            <p className="max-w-3xl mx-auto mt-4 text-xl text-center font-normal text-[#0b1056]">Discover the latest features designed to enhance our support services and provide a better experience for individuals with disabilities.</p>
          </div>
              ...
              <div className="mt-4 space-y-12">
                <div className="flex">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center w-12 h-12 -mt-2 rounded-md">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  ...
                  <div className="ml-4">
                    <h4 className="text-xl font-bold text-[#0b1056]">Customized Support Plans</h4>
                    <p className="mt-4 text-[#0b1056c1] font-semibold">Our new features allow for highly personalized support plans, ensuring that each individual receives tailored assistance based on their specific needs and preferences.</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <h4 className="text-xl font-bold text-[#0b1056]">Interactive Support Resources</h4>
                    <p className="mt-4 text-[#0b1056c1] font-semibold">Access a diverse range of interactive resources designed to make support services more engaging and informative, helping you make the most of our offerings.</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <h4 className="text-xl font-bold text-[#0b1056]">Enhanced Video Consultations</h4>
                    <p className="mt-4 text-[#0b1056c1] font-semibold">Our platform now supports enhanced video consultations, providing a smoother and more reliable experience for remote support and guidance.</p>
                  </div>
                </div>
                <div className="flex">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <h4 className="text-xl font-bold text-[#0b1056]">Advanced Feedback Tools</h4>
                    <p className="mt-4 text-[#0b1056c1] font-semibold">Our new feedback tools provide more options for users to share their experiences and suggestions, helping us continuously improve our services.</p>
                  </div>
                </div>
              </div>
            </div>
