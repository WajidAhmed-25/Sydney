...
<div className="flex flex-col h-auto mt-16 mb-32 md:flex-row">
      <div className="flex flex-col justify-center w-full p-6 text-white bg-[#070a37] md:w-[60%] md:p-10 md:pt-20 md:pb-16">
        ...
        <div className="mb-4 md:mb-8">
          <p className="text-sm leading-relaxed md:text-lg">
          <FontAwesomeIcon icon={faRightLong}   className="mr-4 text-white"/>      It could be challenging to live a life independently without anyone’s support. You may be living in your own house, rented apartment or shared accommodation. Wherever you may live, we respect your wish to live independently and are ready to support you 24×7 with all your daily tasks.
          </p>
        </div>
        <div className="mb-4 md:mb-8">
          <p className="text-sm leading-relaxed md:text-lg">
          <FontAwesomeIcon icon={faRightLong}   className="mr-4 text-white"/>        Our trained staff can help you with the following tasks:
          </p>
        </div>
...
<div className="flex flex-wrap p-4 -mx-2 lg:w-[95%] sm:mx-auto sm:mb-2">
    {continents.map((continent, index) => (
        ...
        <div className="mb-4 md:mb-8">
          <p className="text-sm leading-relaxed md:text-lg">
          <FontAwesomeIcon icon={faRightLong}   className="mr-4 text-white"/>      Our friendly staff will look after your every need and help you live a joyful life.
          </p>
        </div>
